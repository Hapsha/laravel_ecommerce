 ...
 <div class="container">
  <div class="about_top">
  	<div class="col-md-4 span1">
  	    <h3>Who We Are</h3>
		<img src="{{ asset('images/frontend_images/images/p2.jpg') }}" class="img-responsive" alt=""/>
  	     ...
  	     <div class="col-md-6">
			...
			<div class="col-md-6 span_3">
				...
				<ul class="about_box span_1">
				  <li class="box_img"><img src="{{ asset('images/frontend_images/images/p9.jpg') }}" class="img-responsive" alt=""></li>
				...
				<ul class="about_box span_1">
				  <li class="box_img"><img src="{{ asset('images/frontend_images/images/p11.jpg') }}" class="img-responsive" alt=""></li>
				  <li class="box_desc">Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum. Mirum est notare quam littera gothica, quam nunc putamus parum claram,</li>
				  <h4>Finibus Bonorum <span><a href="#">http://demolink.org</a></span></h4>
				  <div class="clearfix"> </div>
				</ul>

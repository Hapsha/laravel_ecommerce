	  ...
	  <div class="content_top">
	  	<div class="container">
		   ...
		   <div class="col-md-9 content_right">
		   	<h4 class="head"><span class="m_2">{{ $categoryDetails->name }}</h4>
		   	<div class="top_grid1">
		    ...
		    <div class="col-md-4 box_2">
		     	<div class="grid_1">
			        ...
			        <img src="{{ asset('../images/backend_images/products/small/'.$product->image)}}" class="img-responsive" alt=""/></div>
		     	   <div class="grid_2">
		     	  	<p>{{$product->product_name}}</p>
		     	  	<ul class="grid_2-bottom">
		     	  		<li class="grid_2-left"><p>$ {{$product->price}}</p></li>

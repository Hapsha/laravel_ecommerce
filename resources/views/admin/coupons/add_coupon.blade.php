...
<div class="page-wrapper">
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          <form class="form-horizontal" method="post" action="/admin/add-coupon">{{ csrf_field() }}
            <div class="card-body">
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                      <input style="width: 50%;" type="text" name="coupon_code" class="form-control" id="coupon_code" placeholder="Coupon Code" minlength="5" maxlength="15" required>
                  </div>
              </div>
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                      <input type="number" name="amount" class="form-control" id="amount" placeholder="Amount" min="1" style="width: 50%;" required>
                  </div>
              </div>
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                      <input type="text" name="expiry_date" class="form-control" id="expiry_date" placeholder="Expiry Date"style="width: 50%;" autocomplete="off">
                  </div>
              </div>

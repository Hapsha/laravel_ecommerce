...
class ProductsController extends Controller
{
    ...
    public function editProduct(Request $request, $id=null){
        ...
        if($request->isMethod('post')){
            ...
            Product::where(['id'=>$id])->update(['category_id'=>$data['category_id'],'product_name'=>$data['product_name'],'product_code'=>$data['product_code'],'product_color'=>$data['product_color'],'description'=>$data['description'],'features'=>$data['features'],'price'=>$data['price'],'image'=>$filename,'status'=>$status]);
        ...
        $categories_dropdown = "<option selected disabled>Select</option>";
            ...
            // Categories dropdown ends;
        return view('admin.products.edit_product')->with(compact('products','categories_dropdown'));
    }
    ...
    public function addAttributes(Request $request,$id=null){
       ...
       // echo "<pre>"; print_r($products); die;
                ...
                if(!empty($val)){
                    ...
                    //prevent duplicate size
                      $attrCountSizes = ProductsAttribute::where(['product_id'=>$id,'size'=> $data['size'][$key]])->count();
                        if($attrCountSizes>0){
                          return redirect('admin/add-attributes/'.$id)->with('flash_message_error','Size already exists for this product! Please add another Size.');  
                        }  
        ...
        return view('admin.products.add_attributes')->with(compact('products'));
    }
    ...
    public function addImages(Request $request,$id=null){
        ...
        if($request->isMethod('post')){
            ...
            return redirect('admin/add-images/'.$id)->with('flash_message_success','Product Images has been saved successfully!');
            
        }

        $productsImages = ProductsImage::where(['product_id'=>$id])->get();

        return view('admin.products.add_images')->with(compact('products','productsImages'));
    }
    ...
    public function products($url = null){
        ...
        return view('products.listing')->with(compact('categories','categoryDetails','productsAll','bannerImage'));
    }
    ...
    public function product($id = null){
        ...
        $relatedProducts = Product::where('id','!=',$id)->where(['category_id'=>$productsDetails->category_id])->get();
        ...
        return view('products.detail')->with(compact('productsDetails','categories','productAltImages','total_stock','relatedProducts'));
    }
    ...
    public function cart(){
        ...
        foreach($userCart as $key =>$product){
            $productsDetails = Product::where('id',$product->product_id)->first();
